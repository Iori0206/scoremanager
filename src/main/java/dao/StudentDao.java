...
public class StudentDao extends DAO {
    ...
    public List<Student> filter(School school) throws Exception {
        ...
        String sql =
            "SELECT * FROM student WHERE school_cd = ? ORDER BY no ASC";
     ...
     * クラス一覧取得
     */
    public List<String> filterClassNum(School school)
        throws Exception {
        ...
        try (
            ...
            try (ResultSet rs = st.executeQuery()) {
                ...
                if (rs.next()) {
                    ...
                    student = mapToStudent(rs, school);
                }
            }
        }
    ...
    public boolean save(Student student) throws Exception {
        ...
        if (existing == null) {
            ...
            sql =
                "INSERT INTO student " +
                "(name, ent_year, class_num, is_attend, school_cd, no) " +
                "VALUES (?, ?, ?, ?, ?, ?)";
